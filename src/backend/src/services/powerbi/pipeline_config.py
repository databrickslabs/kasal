"""Power BI API extraction and pipeline-configuration derivation.

Shared by the pipeline config and UC metric view tools. Authentication supplied
by tools still goes through AadService; the standalone CLI uses get_token.
This module has no CLI argument parsing or process-exit behavior.
"""
