                ...
                try:
                    ...
                    if tables:
                        ...
                        if memory_table:
                            ...
                            _validate_identifier(memory_table, "table name")
                            ...
                            # Validate all column identifiers before building query
                            _validate_identifier(id_field, "column name")
                            if content_field:
                                _validate_identifier(content_field, "column name")
                            if timestamp_field:
                                _validate_identifier(timestamp_field, "column name")
                    ...
                    try:
                        ...
                        for table in tables:
                            ...
                            try:
                                ...
                                logger.warning(f"Skipping table with unsafe name: {table!r}")
                                continue
                            ...
                            for column in content_columns:
                                ...
                                try:
                                    ...
                                    logger.warning(f"Skipping column with unsafe name: {column!r}")
                                    continue
