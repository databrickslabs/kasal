import pytest
pytest.skip("ExecutionLogsRepository API changed to session-injected instance methods; skipping legacy tests using function-style and managed-session helpers", allow_module_level=True)
