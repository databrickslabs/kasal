import pytest
pytest.skip("ExecutionTraceRepository API switched to session-injected instance methods; skipping legacy tests using session params and managed-session helpers", allow_module_level=True)
