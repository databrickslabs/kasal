...
def _crew_execution_context(crew, mlflow_result=None, mcp_warnings=None, otel_bridge=None):
    ...
    patches = [
        patch("src.engines.crewai.paths.crew.crew_preparation.CrewPreparation",
              return_value=mock_crew_prep),
        patch("src.engines.crewai.infra.trace_management.TraceManager", mock_trace_manager),
        ...
        patch("src.engines.crewai.infra.logging_config.ExecutionContextFormatter",
              return_value=MagicMock()),
        patch("src.engines.crewai.infra.logging_config.set_execution_context"),
...
class TestRunCrewInProcessWithMockCrew:
    ...
    def test_crew_execution_event_bus_flush_timeout(self):
        ...
        patches = [
            ...
            patch("src.engines.crewai.infra.trace_management.TraceManager",
